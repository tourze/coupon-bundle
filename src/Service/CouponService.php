...
use CouponBundle\Event\CodeNotFoundEvent;
...
use CouponBundle\Event\SendCodeEvent;
use CouponBundle\Exception\CodeNotFoundException;
use CouponBundle\Exception\CodeUsedException;
